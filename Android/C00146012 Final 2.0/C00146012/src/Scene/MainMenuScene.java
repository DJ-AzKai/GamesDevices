...
//	    optionsMenuItem.setScale(0.5f, 1.0f);
	    ...
	    playMenuItem.setPosition(playMenuItem.getX() - 50, playMenuItem.getY());
	    optionsMenuItem.setPosition(optionsMenuItem.getX() - 50, optionsMenuItem.getY() + 75);
