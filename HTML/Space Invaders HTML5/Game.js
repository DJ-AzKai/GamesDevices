...
function Game() {
	...
	{
		this.TextContext.clearRect(125,0, 120,50);
		this.TextContext.font = "20px Verdana";
		this.TextContext.fillStyle= "#00ff80";
		this.TextContext.fillText("Misses: " + misses, 130,20);
	}
	this.drawScore = function()
	{
		this.TextContext.clearRect(0,0, 120,50); //clear our small canvas.
		this.TextContext.font="20px Verdana";
		// Create gradient
		...
		this.TextContext.fillText("Score: "+ score,0,20);
	}
